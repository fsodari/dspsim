...
if [[ ! -d "${SPDLOG_DIR}" ]]; then
    ...
    cmake -S ./deps/spdlog -B ./deps/spdlog/build -DCMAKE_CXX_STANDARD=23 -DCMAKE_CXX_STANDARD_REQUIRED=ON -DCMAKE_BUILD_TYPE=Release -DSPDLOG_BUILD_PIC=ON -DSPDLOG_BUILD_SHARED=OFF
