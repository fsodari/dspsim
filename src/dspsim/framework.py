...
def _sclass(width: int, signed: bool) -> type[SignalT]:
    """"""
...
def _dffclass(width: int, signed: bool) -> type[DffT]:
    """"""
...
def _signal(initial: int = 0, *, width: int = 1, signed: bool = False) -> SignalT:
    ...
    return _sclass(width, signed)(initial, width)
...
def _dff(
    ...
    """Create a signal of the correct stdint type based on the bitwidth."""
    return _dffclass(width, signed)(clk, initial, width)
