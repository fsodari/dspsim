...
NB_MODULE(_framework, m)
{
  ...
  // Signals
  bind_signal<int8_t>(m, "Signal8");
  bind_signal<int16_t>(m, "Signal16");
  bind_signal<int32_t>(m, "Signal32");
  bind_signal<int64_t>(m, "Signal64");
  ...
  // Dffs
  bind_dff<int8_t>(m, "Dff8");
  bind_dff<int16_t>(m, "Dff16");
  bind_dff<int32_t>(m, "Dff32");
  bind_dff<int64_t>(m, "Dff64");
  ...
  // Axis Tx
  bind_axis_tx<int8_t>(m, "AxisTx8");
  bind_axis_tx<int16_t>(m, "AxisTx16");
  bind_axis_tx<int32_t>(m, "AxisTx32");
  bind_axis_tx<int64_t>(m, "AxisTx64");
  ...
  // Axis Rx
  bind_axis_rx<int8_t>(m, "AxisRx8");
  bind_axis_rx<int16_t>(m, "AxisRx16");
  bind_axis_rx<int32_t>(m, "AxisRx32");
  bind_axis_rx<int64_t>(m, "AxisRx64");
  ...
  // Wishbone Master
  bind_wisbone_m<uint32_t, int8_t>(m, "WishboneM8");
  bind_wisbone_m<uint32_t, int16_t>(m, "WishboneM16");
  bind_wisbone_m<uint32_t, int32_t>(m, "WishboneM32");
  bind_wisbone_m<uint32_t, int64_t>(m, "WishboneM64");
